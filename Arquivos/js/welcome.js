...
$(window).on("error", function(evt) {
    ...
    friendly_txt = "Opa! A Central Horizon OS, encontrou um erro interno.\n\nInforme aos desenvolvedores do Horizon OS para que isso possa ser corrigido imediatamente.";
    if (e.message) {
        alert(friendly_txt + "\n\nError:\n\t" + e.message + "\nLine:\n\t" + e.lineno + "\nFile:\n\t" + e.filename);
    } else {
...
function smoothPageFade(target_href) {
    ...
    $('#navigation-topo').addClass("animated fadeOut");
    $('#queue-cards-base').addClass("animated fadeOut");
...
if (current_page == 'index.html') {
    ...
    $('#navigation-topo').hide();
    $('#queue-cards-base').hide();
    ...
    function showFontesLoja(subtitle) {
        switchCategory(currentCategory, '#list-repos', subtitle, true)
        resetNavTabs();
        $('#navigation-font-list').addClass('active');
        $('#dropdown1').addClass('active');
    }

    function showInstalados(subtitle) {
        switchCategory(currentCategory, '#AppsInfoInstalled', subtitle, true)
        resetNavTabs();
        $('#navigation-installed').addClass('active');
        $('#dropdown1').addClass('active');
...
if (current_page == 'propriedades-do-sistema.html') {
